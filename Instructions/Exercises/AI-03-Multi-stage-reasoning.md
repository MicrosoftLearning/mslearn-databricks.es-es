...
1. En el panel de la izquierda, en **Administración de recursos**, selecciona **Claves y puntos de conexión**.

1. Copia el punto de conexión y una de las claves disponibles, ya que los usarás más adelante en este ejercicio.
...
1. Inicia sesión en **Azure Portal** en `https://portal.azure.com`.
1. Crea un recurso de **Azure Databricks** con la siguiente configuración:
...
1. Selecciona **Revisar y crear** y espera a que se complete la implementación. Después, ve al recurso e inicia el espacio de trabajo.
...
1. En una nueva celda, ejecuta el código siguiente para crear un sistema de QA mediante el recuperador y el modelo `gpt-4o`:
